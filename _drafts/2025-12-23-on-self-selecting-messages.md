---
layout: post
title: On Self-Selecting Messages
date: 2025-12-23 17:08 -0600
categories: [Meaning]
...
More extreme examples might be signs at a blind person's convention or an audio track for those at a deaf conference. While this does target those with disabilities, those who have a lose of a primary sense can also self-select through the use of braile or ASL.

The potential for self-selecting messages extends beyond merely understanding the sentence. One can also play into whether the conditions under which a person would even notice the message in the first place.

# Selecting for Spatial Location 

One I thought of when I was younger was that if I arrived back home but wasn't sure if anyone else was there, there really isn't any consequences for shouting: "IS ANYONE HERE?". Either no one is there and thus doesn't care that I yelled or someone does here my question making it legitimate! 

Another fun idea is to use volume as a mechanism. One might quietly whisper...

```If you can hear this, then you are standing too close```

Or to play off of one of the bumper stickers from earlier. One could put up this sign at an art gallery with small text...

```If you can read this, then you are too close to the art piece.```

# Selecting for Understanding

Or one might also consider how familiar one is with certain words such as...

```Did you know gullible isn't in the dictionary?```

Or abilities such as...

```There are two types of people in the world. Those who can extrapolate from incomplete data.```

Or understanding certain concepts such as...
...
# Self-Regulating Messages

A final interesting extension is on what might be called `Self-Regulating Messages`. These would be a combination of two or more self-regulating messages working together to bring the reader into a specific state. One could use the [Hybrid Image](https://en.wikipedia.org/wiki/Hybrid_image) illusion to bring the reader within a specified distance from the message.

![self-regulating-message](/assets/img/too_close_far_illusion.png)
_A Message that Self-Regulates the Distance_

One might also imagine a similar effect with an audio track that has different messages depending on the speed. Setting the faster speed message to "Too Slow" and the slower one to "Too Fast" could bring the listener to adjust the speed within a certain range.

# Self-Selecting Physical Objects

There is also cases where one can imagine tangiable objects that have intended or unintended selection effects.
